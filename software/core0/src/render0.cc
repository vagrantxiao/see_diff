...
)
{
  ...
  if ( check_clockwise( triangle_2d ) == 0 ){
		...
		STREAM_WRITE( Output_1, 1 );
		STREAM_WRITE( Output_1, triangle_2d_same.x0 );
		STREAM_WRITE( Output_1, triangle_2d_same.y0 );
		STREAM_WRITE( Output_1, triangle_2d_same.x1 );
		STREAM_WRITE( Output_1, triangle_2d_same.y1 );
		STREAM_WRITE( Output_1, triangle_2d_same.x2 );
		STREAM_WRITE( Output_1, triangle_2d_same.y2 );
		STREAM_WRITE( Output_1, triangle_2d_same.z );
		STREAM_WRITE( Output_1, max_index[0] );
		STREAM_WRITE( Output_1, max_min[0] );
		STREAM_WRITE( Output_1, max_min[1] );
		STREAM_WRITE( Output_1, max_min[2] );
		STREAM_WRITE( Output_1, max_min[3] );
		STREAM_WRITE( Output_1, max_min[4] );
		return;
  }
  if ( check_clockwise( triangle_2d ) < 0 )
...
#pragma HLS INTERFACE ap_hs port=Output_2
  ...
  //
  input_lo = STREAM_READ( Input_1 );
  input_mi = STREAM_READ( Input_1 );
  input_hi = STREAM_READ( Input_1 );
...
//	dmb();
	 ...
	 pr_flow::stream Input_1( pr_flow::stream_id_t::STREAM_ID_0, pr_flow::direction_t::SW_SHARED,pr_flow::width_t::SW_WIDTH, pr_flow::axi_port_t::HP0,mem );

	 // both tx and rx when doing ps to ps
	 pr_flow::stream Output_redir_odd( pr_flow::stream_id_t::STREAM_ID_1, pr_flow::direction_t::SW_SHARED,pr_flow::width_t::SW_WIDTH, pr_flow::axi_port_t::HP0,mem );

	 // both tx and rx when doing ps to ps
	 pr_flow::stream Output_redir_even( pr_flow::stream_id_t::STREAM_ID_2, pr_flow::direction_t::SW_SHARED,pr_flow::width_t::SW_WIDTH, pr_flow::axi_port_t::HP0,mem );
...
//	dmb();
	 ...
	 // both tx and rx when doing ps to ps
	pr_flow::stream Input_1( pr_flow::stream_id_t::STREAM_ID_0, pr_flow::direction_t::SW_SHARED,pr_flow::width_t::U32_BITS, pr_flow::axi_port_t::HP0,mem );

	 // both tx and rx when doing ps to ps
	pr_flow::stream Output_redir_odd( pr_flow::stream_id_t::STREAM_ID_1, pr_flow::direction_t::SW_SHARED,pr_flow::width_t::U32_BITS, pr_flow::axi_port_t::HP0,mem );

	pr_flow::stream Output_redir_even( pr_flow::stream_id_t::STREAM_ID_2, pr_flow::direction_t::SW_SHARED,pr_flow::width_t::U32_BITS, pr_flow::axi_port_t::HP0,mem );

	 // rx from core0
	pr_flow::stream Output_r2_odd_toptx( pr_flow::stream_id_t::STREAM_ID_0, pr_flow::direction_t::TX,pr_flow::width_t::U32_BITS, pr_flow::axi_port_t::HP0,mem );

	 // rx from core0
	pr_flow::stream Output_r2_odd_bottx( pr_flow::stream_id_t::STREAM_ID_1, pr_flow::direction_t::TX,pr_flow::width_t::U32_BITS, pr_flow::axi_port_t::HP0,mem );

	 // tx to core2
	pr_flow::stream Output_r2_even_toptx( pr_flow::stream_id_t::STREAM_ID_2, pr_flow::direction_t::TX,pr_flow::width_t::U32_BITS, pr_flow::axi_port_t::HP0,mem );

	pr_flow::stream Output_r2_even_bottx( pr_flow::stream_id_t::STREAM_ID_3, pr_flow::direction_t::TX,pr_flow::width_t::U32_BITS, pr_flow::axi_port_t::HP0,mem );
