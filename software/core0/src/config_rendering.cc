...
void init_regs()
{
   ...
   for (i=4; i<8; i++) {Xil_Out32(SLV_REG0+i*4, 0x00000000);}
	...
	write_to_fifo(0x4800, 0x94900fe0, &ctrl_reg);
	write_to_fifo(0x4880, 0x24c80000, &ctrl_reg);
	write_to_fifo(0x1000, 0x91100fe0, &ctrl_reg);
	write_to_fifo(0x1080, 0x21480000, &ctrl_reg);
