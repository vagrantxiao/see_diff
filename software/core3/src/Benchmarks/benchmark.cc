...
int run_benchmark_ps_ps_4core( pr_flow::test_t test, pr_flow::memory_t memory, pr_flow::axi_port_t port )
{
	...
	//
	// Create rx stream
	pr_flow::benchmark_stream Stream_in( pr_flow::stream_id_t::STREAM_ID_1, pr_flow::direction_t::SW_SHARED,pr_flow::SW_WIDTH, port,memory );
	pr_flow::benchmark_stream Stream_out( pr_flow::stream_id_t::STREAM_ID_2, pr_flow::direction_t::SW_SHARED,pr_flow::SW_WIDTH, port,memory );
...
int run_benchmark_ps_pl_4core( pr_flow::test_t test, pr_flow::memory_t memory, pr_flow::axi_port_t port, pr_flow::width_t width )
{
	...
	//
	// Create rx stream
	pr_flow::benchmark_stream Stream_in( pr_flow::stream_id_t::STREAM_ID_1, pr_flow::direction_t::RX,width, port,memory );

	pr_flow::benchmark_stream Stream_out( pr_flow::stream_id_t::STREAM_ID_2, pr_flow::direction_t::TX,width, port,memory );
